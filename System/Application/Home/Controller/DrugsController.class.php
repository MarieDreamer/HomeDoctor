...
class DrugsController extends Controller{
    ...
    public function drugslists(){
        validateUnLoginRedirect();
        try{
            $drugslists = D(self::$DRUGS_MODEL)->drugslists();

            $ajaxReturnData['status']=1;
            $ajaxReturnData['message']='操作成功';
            $ajaxReturnData['drugslists']=$drugslists;
        }catch(\Exception $e){
            $ajaxReturnData['status']=0;
            $ajaxReturnData['message']='操作失败'.$e->getMessage();
        }
    ...
    public function choicelists(){
        validateUnLoginRedirect();
        try{
            $choicelists = D(self::$DRUGS_MODEL)->choicelists();

            $ajaxReturnData['status']=1;
            $ajaxReturnData['message']='操作成功';
            $ajaxReturnData['choicelists']=$choicelists;
        }catch(\Exception $e){
            $ajaxReturnData['status']=0;
            $ajaxReturnData['message']='操作失败'.$e->getMessage();
        }
